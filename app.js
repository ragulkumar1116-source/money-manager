...
function toggleAuthMode(mode) {
  const loginForm = document.getElementById('login-form-group');
  const registerForm = document.getElementById('register-form-group');
  const forgotForm = document.getElementById('forgot-form-group');
  const subtitle = document.getElementById('auth-subtitle');
  ...
  // Switch display and text based on selected state
  if (mode === 'login') {
    loginForm.style.display = 'block';
    subtitle.innerText = 'Sign in to manage your premium asset logs';
  } else if (mode === 'register') {
    registerForm.style.display = 'block';
    subtitle.innerText = 'Set up your secure, premium account credentials';
  } else if (mode === 'forgot') {
    forgotForm.style.display = 'block';
    subtitle.innerText = 'Enter your email to receive a secure authorization reset link';
  }
}
